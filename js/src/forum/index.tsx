...
app.initializers.add('forumaker-magicbb-buttons', () => {
  extend(TextEditor.prototype, 'toolbarItems', function (items) {
    ...
    if (on('bb_center')) {
      addWrapBlockBtn('bb-center', iconOf('center', 'fas fa-align-center'),
        app.translator.trans('forumaker-magicbb.forum.composer.center_button'),
        'center', 100
      );
    }
    if (on('bb_justify')) {
      addWrapBlockBtn('bb-justify', iconOf('justify', 'fas fa-align-justify'),
    ...
    if (on('bb_spoiler')) {
      addBtn('bb-spoiler', iconOf('spoiler', 'fas fa-layer-group'),
    ...
    if (on('bb_table')) {
      ...
      const handler = (e) => {
        ...
        const tpl = '| Heading 1 | Heading 2 | Heading 3 |\n|---|---|---|\n| Cell 1 | Cell 2 | Cell 3 |\n| Cell 4 | Cell 5 | Cell 6 |';
